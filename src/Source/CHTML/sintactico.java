...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Feb 22 13:29:42 CST 2018
  */
  ...
  public final java_cup.runtime.Symbol CUP$sintactico$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$sintactico$act_num)
		...
		nodoChtml nuevo = new nodoChtml("CONTENIDOCELDA", Interfaz.contadorChtml++);
								if(l!=null){nuevo.add(l);}
								if(b!=null){nuevo.add(b);}
								RESULT= nuevo;
		...
		nodoChtml contenido = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nodoChtml nuevo = new nodoChtml("CELDAC");												
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioCeldaCabecera"));																				
										if(elementos!=null){nuevo.add(elementos);}	
										nuevo.add(new nodoChtml("mayorQue"));
										if(contenido!=null){nuevo.add(contenido);}																												
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finCeldaCabecera"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		nodoChtml contenido = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nodoChtml nuevo = new nodoChtml("CELDA");												
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioCelda"));																				
										if(elementos!=null){nuevo.add(elementos);}	
										nuevo.add(new nodoChtml("mayorQue"));
										if(contenido!=null){nuevo.add(contenido);}																												
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finCelda"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		nodoChtml celdas = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioFila"));																				
										if(elementos!=null){nuevo.add(elementos);}	
										nuevo.add(new nodoChtml("mayorQue"));
										if(celdas!=null){nuevo.add(celdas);}																												
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finFila"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		nodoChtml f = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
					...
					nodoChtml nuevo = new nodoChtml("LISTAFILA");																									
					if(f!=null){nuevo.add(f);}	
					RESULT=nuevo;
		...
		nodoChtml contenido = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nodoChtml nuevo = new nodoChtml("TABLA");												
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioTabla"));																				
										nuevo.add(new nodoChtml("mayorQue"));
										if(contenido!=null){nuevo.add(contenido);}									
										nuevo.add(new nodoChtml("finTabla"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		String path = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)).value;
										...
										nodoChtml nuevo = new nodoChtml("RUTA");												
										nuevo.add(new nodoChtml("ruta"));
										nuevo.add(new nodoChtml("asignacion"));											
										nuevo.add(new nodoChtml("path", new nodoChtml(path)));																																													
										nuevo.add(new nodoChtml("puntoComa"));
										RESULT=nuevo;
		...
		String met = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)).value;
										...
										nodoChtml nuevo = new nodoChtml("CLICK");												
										nuevo.add(new nodoChtml("click"));
										nuevo.add(new nodoChtml("asignacion"));											
										nuevo.add(new nodoChtml("metodo", new nodoChtml(met)));																																													
										nuevo.add(new nodoChtml("puntoComa"));
										RESULT=nuevo;
		...
		nodoChtml r = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
			...
			nodoChtml nuevo = new nodoChtml("EI1");												
			if(r!=null){nuevo.add(r);}
			RESULT=nuevo;
		...
		nodoChtml e = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
			...
			nodoChtml nuevo = new nodoChtml("EI");												
			if(e!=null){nuevo.add(e);}			
			RESULT=nuevo;
		...
		nodoChtml e = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
				...
				nodoChtml nuevo = new nodoChtml("ATRIBUTOS");												
				if(e!=null){nuevo.add(e);}			
				RESULT=nuevo;
		...
		nodoChtml c = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
								...
								nodoChtml nuevo = new nodoChtml("ATRIBUTOS1");												
								if(a!=null){nuevo.add(a);}			
								if(c!=null){nuevo.add(c);}			
								RESULT=nuevo;
		...
		int rright = ((java_cup.runtime.Symbol)CUP$sintactico$stack.peek()).right;
		nodoChtml r = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
		nodoChtml nuevo = new nodoChtml("AE1");
			if(r!=null){nuevo.add(r);}
			RESULT=nuevo;
		...
		int rright = ((java_cup.runtime.Symbol)CUP$sintactico$stack.peek()).right;
		nodoChtml r = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
		nodoChtml nuevo = new nodoChtml("AE");
			if(r!=null){nuevo.add(r);}
			RESULT=nuevo;
		...
		String cad = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioBoton"));
										
										nuevo.add(new nodoChtml("mayorQue"));
										nuevo.add(new nodoChtml("cadena", new nodoChtml(cad)));																																													
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finBoton"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		String cad = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioEnlace"));
										//if(ae!=null){nuevo.add(ae);}	
										nuevo.add(new nodoChtml("mayorQue"));
										nuevo.add(new nodoChtml("cadena", new nodoChtml(cad)));																																													
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finEnlace"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		nodoChtml e = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-4)).value;
										...
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioImagen"));
										if(e!=null){nuevo.add(e);}	
										nuevo.add(new nodoChtml("mayorQue"));
										//nuevo.add(new nodoChtml("path", new nodoChtml(ruta)));																																													
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finImagen"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
...
//										if(elementos!=null){nuevo.add(elementos);}	
		...
		String cad = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
										...
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("inicioTexto"));										
										nuevo.add(new nodoChtml("mayorQue"));
										nuevo.add(new nodoChtml("cadena", new nodoChtml(cad)));																																													
										nuevo.add(new nodoChtml("menorQue"));
										nuevo.add(new nodoChtml("finTexto"));
										nuevo.add(new nodoChtml("mayorQue"));
										RESULT=nuevo;
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)).value;
										...
										nuevo.add(new nodoChtml("asignacion"));
										nuevo.add(new nodoChtml("valorAlineado", new nodoChtml(id)));
										nuevo.add(new nodoChtml("puntoComa"));																																													
										RESULT=nuevo;
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)).value;
										...
										nuevo.add(new nodoChtml("asignacion"));
										nuevo.add(new nodoChtml("id", new nodoChtml(id)));
										nuevo.add(new nodoChtml("puntoComa"));																																													
										RESULT=nuevo;
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)).value;
											...
											nodoChtml nuevo = new nodoChtml("ELEMENTO");												
											nuevo.add(new nodoChtml("idCcss"));
											nuevo.add(new nodoChtml("asignacion"));
											nuevo.add(new nodoChtml("id", new nodoChtml(id)));
											nuevo.add(new nodoChtml("puntoComa"));																																													
											RESULT=nuevo;
		...
		nodoChtml der = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
							...
							nodoChtml nuevo = new nodoChtml("ELEMENTOS1");
							if(iz!=null){nuevo.add(iz);}
							if(der!=null){nuevo.add(der);}
							RESULT= nuevo;
          ...
          case 38: // PANEL ::= menorQue inicioPanel mayorQue menorQue finPanel mayorQue 
            {
              nodoChtml RESULT =null;
												...
												nuevo.add(new nodoChtml("menorQue"));
												nuevo.add(new nodoChtml("inicioPanel"));
												//if(elementos!=null){nuevo.add(elementos);}	
												nuevo.add(new nodoChtml("mayorQue"));																									
												nuevo.add(new nodoChtml("menorQue"));
												nuevo.add(new nodoChtml("finPanel"));
												nuevo.add(new nodoChtml("mayorQue"));																																													
												RESULT=nuevo;
		...
		nodoChtml t = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
							...
							nodoChtml nuevo = new nodoChtml("CONTENIDOCUERPO");												
							if(t!=null){nuevo.add(t);}																																																				
							RESULT=nuevo;
		...
		nodoChtml b = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
							...
							nodoChtml nuevo = new nodoChtml("CONTENIDOCUERPO");												
							if(cuerpo!=null){nuevo.add(cuerpo);}	
							if(b!=null){nuevo.add(b);}																																													
							RESULT=nuevo;
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)).value;
												...
												nodoChtml nuevo = new nodoChtml("ESTILOCUERPO");												
												nuevo.add(new nodoChtml("id", new nodoChtml(id)));																						
												RESULT=nuevo;
		...
		nodoChtml estilo = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-4)).value;
												...
												nodoChtml nuevo = new nodoChtml("CUERPO");												
												if(estilo!=null){nuevo.add(estilo);}
												RESULT=nuevo;
		...
		String valCadena = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-3)).value;
												...
												nuevo.add(new nodoChtml("cadena", new nodoChtml(valCadena)));																							
												RESULT=nuevo;
		...
		String path = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-5)).value;
												...
												nodoChtml nuevo = new nodoChtml("DEFCCSS");												
												nuevo.add(new nodoChtml("pathComillas", new nodoChtml(path)));																							
												RESULT=nuevo;
		...
		String path = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.elementAt(CUP$sintactico$top-5)).value;
												...
												nodoChtml nuevo = new nodoChtml("DEFCJS");												
												nuevo.add(new nodoChtml("pathComillas", new nodoChtml(path)));																							
												RESULT=nuevo;
		...
		nodoChtml r = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
							...
							nodoChtml nuevo = new nodoChtml("DEFARCHIVO");							
							nuevo.add(r);					
							RESULT=nuevo;
		...
		nodoChtml der = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
												...
												nodoChtml nuevo = new nodoChtml("LISTAARCHIVOS");												
												nuevo.add(iz);
												nuevo.add(der);							
												RESULT=nuevo;
		...
		nodoChtml der = (nodoChtml)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
										...
										nodoChtml nuevo = new nodoChtml("CONTENIDOENCABEZADO");												
										nuevo.add(iz);							
										nuevo.add(der);																								
										RESULT=nuevo;
