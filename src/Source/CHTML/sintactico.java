...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Feb 18 20:40:06 CST 2018
  */
public class sintactico extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\010\000\002\002\004\000\002\002\004\000\002\013" +
    "\005\000\002\014\005\000\002\003\004\000\002\015\005" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\013\000\004\004\006\001\002\000\004\004\012\001" +
    "\002\000\004\002\011\001\002\000\004\006\007\001\002" +
    "\000\004\005\010\001\002\000\004\004\uffff\001\002\000" +
    "\004\002\001\001\002\000\004\007\014\001\002\000\004" +
    "\002\000\001\002\000\004\005\015\001\002\000\004\002" +
    "\ufffe\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\013\000\006\002\004\013\003\001\001\000\004\014" +
      ...
      switch (CUP$sintactico$act_num)
        {
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // ENCABEZADO ::= INICIOENCABEZADO FINENCABEZADO 
            {
              nodoChtml RESULT =null;
		...
		String r3 = (String)((java_cup.runtime.Symbol) CUP$sintactico$stack.peek()).value;
		 nodoChtml nuevo = new nodoChtml("INICIOCHTML",Interfaz.contadorChtml++);												
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // CHTML ::= INICIOCHTML FINCHTML 
            {
              nodoChtml RESULT =null;
		...
		Interfaz.raizChtml.setValue("DOCUMENTO");
              ...
              CUP$sintactico$result = parser.getSymbolFactory().newSymbol("CHTML",0, ((java_cup.runtime.Symbol)CUP$sintactico$stack.elementAt(CUP$sintactico$top-1)), ((java_cup.runtime.Symbol)CUP$sintactico$stack.peek()), RESULT);
            }
          return CUP$sintactico$result;
